...
class Main:
    ...
    def set_adb(self):
        ...
        print()
        print()
        ipAddress = input("\033[32m设备WEB地址(例如 192.168.100.1): \033[0m\033[31m\033[1m")
        print(f"\033[36m\033[1m{self.split_mark}\033[0m")
        print()
        print(
        ...
        print()
        print(
            f"\033[36m\033[1m =------\033[0m\033[35m\033[1m选择模式\033[36m\033[1m------------------------------------------------------------------------------------------------=")
        print(
            "\033[36m\033[1m =                                                                                                             =")
        print(
        ...
        if adb_selection == "1":
            ...
            call(['curl', f"http://{ipAddress}/goform/goform_set_cmd_process?goformId=SET_DEVICE_MODE&debug_enable=2"])
            call(['curl', f"http://{ipAddress}/goform/goform_set_cmd_process?goformId=SET_DEVICE_MODE&debug_enable=1"])
            call(['curl', f"http://{ipAddress}/reqproc/proc_post?goformId=SET_DEVICE_MODE&debug_enable=1"])
            print()
            call(['curl',
                  f"http://{ipAddress}/reqproc/proc_post?goformId=SET_DEVICE_MODE&debug_enable=1&password=coolfish666@Qiruizhilian20241202"])
            call(['curl',
                  f"http://{ipAddress}/reqproc/proc_post?goformId=SET_DEVICE_MODE&debug_enable=1&password=xscmadmin888@Qiruizhilian20241202"])
            call(['curl',
                  f"http://{ipAddress}/reqproc/proc_post?goformId=SET_DEVICE_MODE&debug_enable=1&password=MM888@Qiruizhilian20241202"])
            call(['curl',
                  f"http://{ipAddress}/reqproc/proc_post?goformId=SET_DEVICE_MODE&debug_enable=1&password=159258@Qiruizhilian20241202"])
            print("\033[32m\033[1m\n稍后重启设备(5秒).....\033[0m\033[34m\033[1m")
            sleep(5)
            call(['curl', f"http://{ipAddress}/reqproc/proc_post?goformId=REBOOT_DEVICE"])
            call(['curl', f"http://{ipAddress}/goform/goform_set_cmd_process?goformId=REBOOT_DEVICE"])
            ...
            print("\033[34m\033[1m")
            call(['curl', f"http://{ipAddress}/goform/goform_set_cmd_process?goformId=SET_DEVICE_MODE&debug_enable=3"])
            print("\033[32m\033[1m\n稍后重启设备(5秒).....\033[0m\033[34m\033[1m")
            sleep(5)
            call(['curl', f"http://{ipAddress}/reqproc/proc_post?goformId=REBOOT_DEVICE"])
            call(['curl', f"http://{ipAddress}/goform/goform_set_cmd_process?goformId=REBOOT_DEVICE"])
            ...
            print("\033[34m\033[1m")
            call(['curl', f"http://{ipAddress}/goform/goform_set_cmd_process?goformId=SET_DEVICE_MODE&debug_enable=0"])
            call(['curl', f"http://{ipAddress}/reqproc/proc_post?goformId=ID_SENDAT&at_str_data=AT%2BZMODE%3D0"])
            print("\033[32m\033[1m\n稍后重启设备(5秒).....\033[0m\033[34m\033[1m")
            sleep(5)
            call(['curl', f"http://{ipAddress}/reqproc/proc_post?goformId=REBOOT_DEVICE"])
            call(['curl', f"http://{ipAddress}/goform/goform_set_cmd_process?goformId=REBOOT_DEVICE"])
            ...
            print("\033[34m\033[1m")
            call(['curl', f"http://{ipAddress}/reqproc/proc_post?goformId=LOGIN&password=cmVtb19zdXBlcl9hZG1pbl8yMjAx"])
            call(['curl', f"http://{ipAddress}/reqproc/proc_post?goformId=LOGIN&password=YWRtaW4%3D"])
            print("\033[32m\033[1m\n检测到阻止,正在绕过.....\033[0m\033[34m\033[1m")
            call(['curl',
                  f"http://{ipAddress}/reqproc/proc_post?goformId=REMO_SIM_SELECT_R1865&isTest=false&sim_option_id=3&select_sim_mode=1"])
            call(
                ['curl', f"http://{ipAddress}/reqproc/proc_post?goformId=SysCtlUtal&action=System_MODE&debug_enable=1"])
            call(['curl', f"http://{ipAddress}/reqproc/proc_post?goformId=ID_SENDAT&at_str_data=AT%2BZMODE%3D1"])
            call(['curl', f"http://{ipAddress}/reqproc/proc_post?goformId=SET_DEVICE_MODE&debug_enable=1"])
            print("\033[32m\033[1m\n稍后重启设备(5秒).....\033[0m\033[34m\033[1m")
            sleep(5)
            call(['curl', f"http://{ipAddress}/reqproc/proc_post?isTest=false&goformId=RESTORE_FACTORY_SETTINGS"])
            input("\033[32m\033[1m\n操作已完成，回车返回\033[0m")
