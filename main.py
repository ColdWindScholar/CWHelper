...
class Main:
    ...
    def flash_mtd4(self):
        ...
        call(['adb', 'shell', "ln", "-s", '/tmp/busybox', '/tmp/sh'])
        call(['adb', 'shell', "ln", "-s", '/tmp/busybox', '/tmp/reboot'])
        call(['adb', "shell", 'chmod', '+x', '/tmp/sh'])
        call(['adb', "shell", 'chmod', '+x', '/tmp/dd'])
        call(['adb', "shell", 'chmod', '+x', '/tmp/reboot'])
        ...
        call(["adb", "push", rom_path, "/mnt/userdata/temp/mtd4_to_flash.bin"])
    ...
    def print_menu(self):
        while True:
            ...
            print(
                "\033[33m         1.串口工具         2.云小帆助手      3.1869工具      4.西瓜味asr工具(最终)   5.UFI_TOOL\033[0m")
            print(
