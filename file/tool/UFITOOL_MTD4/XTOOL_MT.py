...
class ATToolWindow(QWidget):
    ...
    def init_ui(self):
        ...
        factory_on_button.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        ...
        factory_off_button.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        ...
        query_band_button.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        ...
        factory_on_button_.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        ...
        factory_off_button_.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        ...
        query_band_button_.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        grid_layout.addWidget(query_band_button_, 1, 2, 1, 2)
        imei_label = QLabel(' ZXIC设备改川:')
        imei_label.setAlignment(Qt.AlignmentFlag.AlignLeft)
        ...
        imei_label_2.setAlignment(Qt.AlignmentFlag.AlignLeft)
        ...
        imei_label_3.setAlignment(Qt.AlignmentFlag.AlignLeft)
        ...
        entry_label.setAlignment(Qt.AlignmentFlag.AlignLeft)
